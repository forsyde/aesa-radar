...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,firstnumber=412,]
...
\NormalTok{    emv }\FunctionTok{=}\NormalTok{ (V.fanoutn (nFFT }\FunctionTok{+} \DecValTok{2}\NormalTok{) dummy) }\FunctionTok{<++>}\NormalTok{ (V.farm11 aritMean neighbors)}
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,firstnumber=634,]
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,firstnumber=658,]
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,firstnumber=87,]
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,firstnumber=90,]
\CommentTok{-- Can be used without importing the ForSyDe.Atom libraries.}
...
\centering
\includegraphics{figs/AESA_INDATA.pdf}
...
\centering
\includegraphics{figs/AESA_OUTPUT.pdf}
