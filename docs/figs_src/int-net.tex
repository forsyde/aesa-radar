...
\begin{tikzpicture}[scale=1,yscale=1.1]
    ...
    \standard[process, moc=sdf,ni=2,type=comb,left of=if1] (mrg) {merge};
  ...
  \draw[trans={s=sdf,<-}{int-west}{v=sdf}] (mrg.w1) --++(-2,0) node[black,anchor=south]{$\langle b^{dfb,r}_{1}...b^{dfb,r}_{N_B}\rangle$};
  \draw[trans={s=sdf,<-}{int-west}{v=sdf}] (mrg.w2) --++(-2,0) node[black,anchor=north]{$\langle b^{dfb,l}_{1}...b^{dfb,l}_{N_B}\rangle$};
  \draw[trans={s=sy}{int-east}{v=sy,->}] (p4) --++(2.5,0) node[black,anchor=south]{$\langle b^{aesa}_{1}...b^{aesa}_{N_B}\rangle$};
